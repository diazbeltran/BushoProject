                ...
                <ScrollView >
                    ...
                    <TouchableHighlight  underlayColor='white'
                       ...
                       <View style={{flexDirection:'row',  width:'90%', }}>
                                ...
                                <Image style={{marginLeft:0, marginTop:0, }} source={require('../../assets/img/Group.png')} />
                                </View> 
                                ...
                                <View style={{flex:1}}>
                                        ...
                                        <Text style={{color:'black', fontFamily:'NunitoSans-Bold', fontSize:18}}>Carlos Becerra</Text>
                                        <Text style={{marginTop:0,color:'#A6A6A6', fontFamily:'NunitoSans-Regular', fontSize:16}}>Recibido a las 22:05 hrs</Text>
                                ...
                                <Image style={{marginLeft:0, marginTop:10, }} source={require('../../assets/img/Ellipse_4.png')} />
                            ...
                            <View style={{marginTop:33, flexDirection:'row',  width:'90%', }}>
                                <View style={{flex:0.2, alignItems:'center'}}>

                                <Image style={{marginLeft:0, marginTop:0, }} source={require('../../assets/img/img_notificacion_1.png')} />
                                </View> 
                                ...
                                <View style={{flex:1}}>
                                        ...
                                        <Text style={{marginTop:0,color:'#A6A6A6', fontFamily:'NunitoSans-Regular', fontSize:16}}>Enviado a las 13:02 hrs</Text>
