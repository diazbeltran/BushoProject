...
import { View, Text,  StyleSheet,Image,TouchableHighlight, ScrollView,TouchableWithoutFeedback,Keyboard, SafeAreaView, KeyboardAvoidingView, } from 'react-native';
...
title="Ingresar"
    ...
    >
        <Text maxFontSizeMultiplier={1} style={{fontFamily:'NunitoSans-Bold',fontSize:16,color:'white',marginTop:'1%', }} underlayColor={'red'}>Ver un tutorial</Text>
    </TouchableHighlight>
...
/>   
<Text maxFontSizeMultiplier={1} style={{backgroundColor:'white', marginTop:'6%', fontFamily:'NunitoSans-Regular',fontSize:16}}> 
...
<View style={{flex:0.1, marginTop:'10%', alignItems:'flex-end', }}> 
