...
export default class PerfilInformacion extends Component {
        ...
        return (
            <View style={{ 
             ...
             <View style={{flexDirection:'row', marginTop:30, marginBottom:20,}}>
                ...
                <Text style={{fontSize:15,marginTop:0, marginLeft:20}}><Icon22 style={{}}  name="star" size={10} color="#545454" /> 5.5</Text>
                <Text style={{fontFamily:'NunitoSans-Blod',fontSize:21,marginTop:5, marginLeft:20,color:'black' }}>Fernando Garrido</Text>
                ...
                <ScrollView >
                    ...
                    <View style={{marginLeft:0, flexDirection:'row'}}>
                        <Text style={{color:'black',fontFamily:'NunitoSans-Blod',fontSize:18}}>
                            Acerca de Fernando
                        </Text>
                        <TouchableHighlight 
                    title="Press me"
                    onPress={() => this.props.navigation.navigate('PerfilInformacionEditar')}
                        >
                            <Icon28 style={{ paddingLeft:10, flex:0.2}}  name="edit" size={20} color="#61D3BA" />
                        </TouchableHighlight>
                        
                        </View>
                    </View>
                    <View style={{marginLeft:20, marginTop:11 ,marginRight:20,}}>
                            <Text style={{ lineHeight: 27, fontFamily:'NunitoSans-Regular',fontSize:16}}>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et. 

Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et. .</Text>

                            <Text style={{marginTop:20, lineHeight: 27, fontFamily:'NunitoSans-Regular',fontSize:16}}>
