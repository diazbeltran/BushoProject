...
<TouchableHighlight 
                ...
                <View style={{flex:0.9}}>
                <Text style={{fontFamily:'NunitoSans-Blod',fontSize:25, marginLeft:10, color:'black', fontWeight:'bold' }}>Historial</Text>
                </View>
            ...
            <View style={{   backgroundColor: 'white' , marginTop:43}} >
